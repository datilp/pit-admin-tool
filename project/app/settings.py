...
SECRET_KEY = 'rl^$*=iqum571ck3%0)wv$sf5m!rl&wbt8zh@0eg4_k5r4ywc#'
...
REST_KNOX = {
  ...
  'AUTO_REFRESH': False,
  # # original # 'EXPIRY_DATETIME_FORMAT': api_settings.DATETME_FORMAT,
  'EXPIRY_DATETIME_FORMAT': '%s',  # seconds since epoch
}
